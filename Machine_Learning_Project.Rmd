...
### 2.a. Row-Columnar percentile presentation of classe(A-E) variables by user
...
```{r, echo=TRUE}  
# displaying classe(A-E) elements summarized and percentile by user name
...
ggplot(trainDataSet, aes(x=classe, fill=user_name)) + geom_bar() + xlab("Classe in bar segments") + ylab("User performances") + ggtitle("Sequence of classe by user")
```
...
suppressMessages(libraries("gbm", "plyr", "dplyr", "parallel", "doParallel"));set.seed(9515)
